...
#define MPU9250_SCLK_Port GPIOB
#define MPU9250_SCLK_Port_Clk_Enable() __HAL_RCC_GPIOB_CLK_ENABLE()
#define MPU9250_SCLK_Pin GPIO_PIN_10

#define MPU9250_SDIN_Port GPIOB
#define MPU9250_SDIN_Port_Clk_Enable() __HAL_RCC_GPIOB_CLK_ENABLE()
...
#define MPU9250_SCLK_Clr() MPU9250_SCLK_Port->BSRR = (uint32_t)MPU9250_SCLK_Pin << 16U
#define MPU9250_SCLK_Set() MPU9250_SCLK_Port->BSRR = MPU9250_SCLK_Pin

#define MPU9250_SDIN_Clr() MPU9250_SDIN_Port->BSRR = (uint32_t)MPU9250_SDIN_Pin << 16U
#define MPU9250_SDIN_Set() MPU9250_SDIN_Port->BSRR = MPU9250_SDIN_Pin
#define MPU9250_READ_SDIN() MPU9250_SDIN_Port->IDR &MPU9250_SDIN_Pin // 0 or 1
...
u8 MPU9250_Read_Byte(u8 devaddr, u8 reg);
