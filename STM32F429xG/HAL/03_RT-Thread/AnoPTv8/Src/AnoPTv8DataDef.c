...
const _st_par_info AnoParInfoList[ANOPTV8_PARNUM] = {
    ...
    {0, 719900, &parListForTest[6], "PID_L_P", "位置：P，放大100倍"},
    {0, 719900, &parListForTest[7], "PID_L_I", "位置：I，放大100倍"},
    {0, 719900, &parListForTest[8], "PID_L_D", "位置：D，放大100倍"},
    {0, 719900, &parListForTest[9], "PID_T_P", "转向：P，放大100倍"},
    {0, 719900, &parListForTest[10], "PID_T_I", "转向：I，放大100倍"},
    {0, 719900, &parListForTest[11], "PID_T_D", "转向：D，放大100倍"},
    {0, 1, &parListForTest[12], "PID_E1_C", "E1，PID控制"},
