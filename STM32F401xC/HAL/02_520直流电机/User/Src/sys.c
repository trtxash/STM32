...
//时钟系统配置函数
//PLL:M/N/P/Q=25/168/2/4
//返回值:0,成功;1,失败
void Stm32_Clock_Init(u32 M, u32 N, u32 P, u32 Q)
{
    ...
    RCC_OscInitStructure.PLL.PLLM = M;                            //主PLLM分频因子
    RCC_OscInitStructure.PLL.PLLN = N;                            //主PLLN倍频因子
    RCC_OscInitStructure.PLL.PLLP = P;                            //副PLLP分频因子
    RCC_OscInitStructure.PLL.PLLQ = Q;                            //副PLLQ分频因子
