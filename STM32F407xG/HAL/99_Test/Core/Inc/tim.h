...
extern TIM_HandleTypeDef htim7;  // DAC触发
extern TIM_HandleTypeDef htim8;  // 4通道PWM
extern TIM_HandleTypeDef htim11; // FreeRTOS任务计时
extern TIM_HandleTypeDef htim13; // USMART
extern TIM_HandleTypeDef htim14; // 定时任务
