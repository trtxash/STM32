...
u8 RTC_Init(void)
{
    ...
    {
        RTC_Set_Time(12, 0, 0, RTC_HOURFORMAT12_PM);            // 设置时间 ,根据实际时间修改
        RTC_Set_Date(22, 11, 8, 2);                             // 设置日期
...
void RTC_Set_AlarmA(u8 week, u8 hour, u8 min, u8 sec)
{
    ...
    HAL_NVIC_SetPriority(RTC_Alarm_IRQn, 2, 0); // 抢占优先级2
...
void RTC_Set_WakeUp(u32 wksel, u16 cnt)
{
    ...
    HAL_NVIC_SetPriority(RTC_WKUP_IRQn, 2, 0); // 抢占优先级2
